...
$string['modulename'] = 'Komenskio Logo';
$string['modulenameplural'] = 'Komenskio Logo';
$string['modulename_help'] = 'Komenskio Logo - tai edukacinė programavimo kalba, kuri skirta mokiniams, pedagogams ir kitai plačiai visuomenei, kuri nori išmokti programuoti.';
$string['comlogo:addinstance'] = 'pridėti nauja comlogo';
$string['comlogo:submit'] = 'Pateikti comlogo';
$string['comlogo:view'] = 'Peržiūrėti comlogo';
$string['comlogofieldset'] = 'Automatinis įvertinimas';
$string['comlogoname'] = 'Komenskio Logo veikla';
$string['comlogoname_help'] = 'Komenskio Logo - tai edukacinė programavimo kalba, kuri skirta mokiniams, pedagogams ir kitai plačiai visuomenei, kuri nori išmokti programuoti.';
$string['comlogo'] = 'Komenskio Logo';
$string['description'] = 'Aprašymas';
$string['pluginadministration'] = 'comlogo administravimas';
$string['pluginname'] = 'comlogo';
$string['submissions'] = 'Pateikti darbai';
$string['drawpage'] = 'Interpretatoriaus puslapis';
$string['autograde']= 'Automatinis įvertinimas';
$string['autograder']= 'Automatinis įvertinimas';
$string['author']= 'Įkėlė';
$string['submittedon']= 'Įkelta';
$string['grader']= 'Įvertino';
$string['grade']= 'Įvertinti darbą';
$string['gradedon']= 'Įvertinta';
$string['userimg']= 'Sprendimo vaizdas';
$string['codelog']= 'Įvykdytos komandos';
$string['run']= 'Paleisti';
$string['stop']= 'Sustabdyti';
$string['clear']= 'Išvalyti';
$string['submit']= 'Pateikti darbą';
$string['entercommand']= 'Įveskite kodą čia...';
$string['nogradercapability'] = 'Vartotojas neturi leidimo vertinti darbus.';
$string['nosubmission'] = 'Nėra pateikto sprendimo';
$string['helppage']= 'Pagalbos puslapis';
$string['teachercode']= 'Sprendimo kodas';
$string['submissionfailed']= 'Darbo pateikimo metu iškilo klaida, bandykitė dar kartą.';
$string['submissionsuccess']= 'Darbas buvo pateiktas.';
$string['submissiongraded']= 'Sprendimą įvertino sistema: ';
$string['submissionwait']= 'Laukiama mokytojo įvertinimo.';
